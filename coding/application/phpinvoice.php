    ...
    ******************************************/
	...
	public function Header() {
		...
		if(!isset($this->productsEnded))  {
			...
			$this->Cell($this->firstColumnWidth,10,iconv("UTF-8", "ISO-8859-1",strtoupper("Description")),0,0,'L',0);
			//$this->Cell($this->columnSpacing,10,'',0,0,'L',0);
			//$this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper("T")),0,0,'C',0);
			if(isset($this->vatField)) {
				$this->Cell($this->columnSpacing,20,'',0,0,'L',0);
				$this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper("Staff")),0,0,'C',0);
			}
			//$this->Cell($this->columnSpacing,10,'',0,0,'L',0);
			//$this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper($this->lang['price'])),0,0,'C',0);
			if(isset($this->discountField)) {
				$this->Cell($this->columnSpacing,10,'',0,0,'L',0);
				$this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper("Status")),0,0,'C',0);
			}
			$this->Cell($this->columnSpacing,10,'',0,0,'L',0);
	...
	public function Body() {	
		...
		if($this->items) {
			foreach($this->items as $item) 
			{
				...
				if(isset($this->vatField)) 
				{
					$this->Cell($this->columnSpacing*2,$cHeight,'',0,0,'L',0);
					if(isset($item['vat'])) {
