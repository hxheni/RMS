...
class phpinvoice extends FPDF_rotation  {
    ...
    public function Header() {
        ...
        if(!isset($this->productsEnded))  {
            ...
            $this->Cell($this->firstColumnWidth,10,iconv("UTF-8", "ISO-8859-1",strtoupper("DISH NAME")),0,0,'L',0);
            ...
            if(isset($this->vatField)) {
                ...
                $this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper("TYPE")),0,0,'C',0);
            }
            //$this->Cell($this->columnSpacing,10,'',0,0,'L',0);
            //$this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper($this->lang['price'])),0,0,'C',0);
            if(isset($this->discountField)) {
                $this->Cell($this->columnSpacing,10,'',0,0,'L',0);
                $this->Cell($width_other,10,iconv("UTF-8", "ISO-8859-1",strtoupper("AMOUNT")),0,0,'C',0);
            }
            $this->Cell($this->columnSpacing,10,'',0,0,'L',0);
